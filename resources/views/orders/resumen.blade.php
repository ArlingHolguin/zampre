            ...
            <div class=" flex items-center justify-between container  py-2">
                <div class="flex gap-2">
                    ...
                    <p class="text-trueGray-800 ml-2">Orden: <span
                            class="font-bold text-orange-600">{{ $orden->code_id }}, Hemos recibido su pedido exitosamente. Te hemos enviado un correo con los detalles de tu pedido.</span>
                    </p>

                </div>
                    <div class="flex items-center justify-center">
                       <a class="bg-orange-600 px-4 py-1 rounded text-white" href="/">Seguir Comprando</a>
                    </div>    
            </div>
